    ...
    [
        {
            ...
            "mentor_id" : 2,
            "client_id" : 1,
            "date_from" : datetime.datetime(2023, 12, 20, 8),
            "date_to" : datetime.datetime(2023, 12, 20, 9),
            ...
            "channel_id" : "test1",
            "mentor_join_call" : datetime.datetime(2023, 12, 20, 8),
            "client_join_call" : datetime.datetime(2023, 12, 20, 8),
            "mentor_date_of_close" : datetime.datetime(2023, 12, 20, 9),
            "client_date_of_close" : datetime.datetime(2023, 12, 20, 9)
        },
        {
            "id" : 2,
            "mentor_id" : 2,            
            "client_id" : 2,
            "date_from" : datetime.datetime(2023, 12, 26, 14),    
            "date_to" : datetime.datetime(2023, 12, 26, 14, 30),
        ...
        },
        {
            ...
            "mentor_id" : 2,
            "client_id" : 1,
            "date_from" : datetime.datetime(2023, 12, 27, 10),    
            "date_to" : datetime.datetime(2023, 12, 27, 10, 15),
        ...
        },
        {
            ...
            "mentor_id" : 1,
            "client_id" : 1,
            "date_from" : datetime.datetime(2023, 12, 28, 10),    
            "date_to" : datetime.datetime(2023, 12, 28, 11),
        ...
        },
        {
            ...
            "mentor_id" : 4,
            "client_id" : 1,
            "date_from" : datetime.datetime(2023, 12, 28, 17),    
            "date_to" : datetime.datetime(2023, 12, 28, 18),
        ...
        },
        {
            ...
            "mentor_id" : 2,
            "client_id" : 1,
            "date_from" : datetime.datetime(2023, 12, 29, 14),    
            "date_to" : datetime.datetime(2023, 12, 29, 15),
            "price_before_discount" : 12,
            "price_after_discount" : 12,       
            "appointment_type" : AppointmentsType.schudule,
            "state" : AppointmentsState.active,
        ...
        },
        {
            ...
            "mentor_id" : 2,
            "client_id" : 2,
            "date_from" : datetime.datetime(2023, 12, 29, 15),    
            "date_to" : datetime.datetime(2023, 12, 29, 16),

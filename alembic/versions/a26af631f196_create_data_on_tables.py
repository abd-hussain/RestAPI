    ...
    [
        {
            ...
            "date_from" : datetime.datetime(2024, 1, 20, 8),
            "date_to" : datetime.datetime(2024, 1, 20, 9),
            ...
            "channel_id" : "test1",
            "mentor_join_call" : datetime.datetime(2024, 1, 25, 8),
            "client_join_call" : datetime.datetime(2024, 1, 25, 8),
            "mentor_date_of_close" : datetime.datetime(2024, 1, 25, 9),
            "client_date_of_close" : datetime.datetime(2024, 1, 25, 9)
        },
        {
            "id" : 2,
            "mentor_id" : 15,            
            "client_id" : 2,
            "appointment_type" : AppointmentsType.schudule,
            "date_from" : datetime.datetime(2024, 1, 29, 14),    
            "date_to" : datetime.datetime(2024, 1, 29, 14, 15),
        ...
        },
        {
            ...
            "date_from" : datetime.datetime(2024, 2, 29, 10),    
            "date_to" : datetime.datetime(2024, 2, 29, 10, 15),
            "state" : AppointmentsState.active,
            "discount_id" : None,
            "is_free" : True,
            "price" : 0,
        ...
        },
        {
            ...
            "client_id" : 1,
            "appointment_type" : AppointmentsType.instant,
            "date_from" : datetime.datetime(2024, 1, 25, 0),    
            "date_to" : datetime.datetime(2024, 1, 25, 0, 30),
            "state" : AppointmentsState.completed,
            "discount_id" : 2,
            "is_free" : False,
            "price" : 20,
        ...
        },
        {
            ...
            "client_id" : 1,
            "appointment_type" : AppointmentsType.instant,
            "date_from" : datetime.datetime(2024, 2, 18, 10),    
            "date_to" : datetime.datetime(2024, 2, 18, 10, 15),
        ...
        },
        {
            ...
            "client_id" : 2,
            "appointment_type" : AppointmentsType.schudule,
            "date_from" : datetime.datetime(2024, 2, 11, 19),    
            "date_to" : datetime.datetime(2024, 2, 11, 19, 30),
        ...
        },
        {
            ...
            "client_id" : 1,
            "appointment_type" : AppointmentsType.schudule,
            "date_from" : datetime.datetime(2024, 1, 31, 20),    
            "date_to" : datetime.datetime(2024, 1, 31, 21),
            "state" : AppointmentsState.active,
            "discount_id" : None,
            "is_free" : False,
            "price" : 20,
        ...
        },
        {
            ...
            "client_id" : 1,
            "appointment_type" : AppointmentsType.instant,
            "date_from" : datetime.datetime(2024, 2, 7, 21),    
            "date_to" : datetime.datetime(2024, 2, 7, 22),
            "state" : AppointmentsState.active,
            "discount_id" : 2,
            "is_free" : False,
            "price" : 20,
        ...
        },
        {
            ...
            "client_id" : 1,
            "appointment_type" : AppointmentsType.schudule,
            "date_from" : datetime.datetime(2024, 2, 2, 14),    
            "date_to" : datetime.datetime(2024, 2, 2, 14, 15),
            "state" : AppointmentsState.active,
            "discount_id" : 2,
            "is_free" : True,
            "price" : 0,
        ...
        },
        {
            ...
            "client_id" : 1,
            "appointment_type" : AppointmentsType.schudule,
            "date_from" : datetime.datetime(2024, 2, 5, 15),    
            "date_to" : datetime.datetime(2024, 2, 5, 15, 15),
            "state" : AppointmentsState.active,
            "discount_id" : None,
            "is_free" : False,
            "price" : 20,
